...
| S127 | Talk tracks | Three-minute, fifteen-minute and deep-dive tracks built from the views; slides deferred to a design-library pass per architecture-base `presentation.md` | done | S126 |
