# Hopin — Taxi App Pre-Plan

**Tagline:** *Hop in. Get there.*
...
- **Fast booking:** one tap to request a ride, with a clear ETA.
- **Transparent pricing:** the fare is shown before the trip starts.
- **Safety built in:** live trip sharing and driver ratings.
- **Cashless:** in-app payment, no need to carry cash.
