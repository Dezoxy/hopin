...
| A-10 | The ambitious scenario needs an engineer from year 2 and partner support from year 3; one person cannot run 20 partners | Costs understated, or the founder becomes the bottleneck ([RISK-004](../risks/architecture-risks.md)) | [Cost model](../../business/three-year-cost-model.md) | Founder | When the fifth partner signs |
