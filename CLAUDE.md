...
- `docs/hopin-plan.md` is the single living plan: product scope, domain model, the S001–S119 step list and a detail section per started step. Expand steps there. Do not create parallel plan files.
